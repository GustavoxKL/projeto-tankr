...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/veiculos.css') }}">
...
<body>
            ...
            <div class="veiculos-container">
                ...
                <div class="page-header">
                    <div class="header-info">
                        <p class="section-subtitle">Gerencie os veículos da sua empresa</p>
                    </div>
    ...
    <script src="{{ asset('js/admin/veiculos.js') }}"></script>
</body>
</html>