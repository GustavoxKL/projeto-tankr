...
<head>
    ...
    <title>TANKR - Motoristas</title>
    <link rel="stylesheet" href="{{ asset('css/admin/dashboard_admin.css') }}">
    <link rel="stylesheet" href="{{ asset('css/admin/motoristas.css') }}">
...
<body>
            ...
            <div class="motoristas-container">
                ...
                <div class="page-header">
                    <div class="header-info">
                        <p class="section-subtitle">Gerencie os motoristas da sua empresa</p>
                    </div>
                    ...
                    <div class="motorista-card" 
                        ...
                        <div class="motorista-info">
                            ...
                            <div class="info-item">
                                ...
                                <span>{{ \App\Helpers\Formatador::telefone($motorista->TelefoneMot) }}</span>
                            </div>
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <form id="formMotorista" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="cnh" name="cnh" maxlength="11" placeholder="Opcional">
                        </div>
    ...
    <script src="{{ asset('js/admin/motoristas.js') }}"></script>
</body>
</html>