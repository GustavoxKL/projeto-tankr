...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/superadmin/motoristas.css') }}">
...
<body>
    ...
    <main class="main-content">
        <!-- Topbar -->
        <header class="topbar">
            <h1 class="page-title">Motoristas Cadastradas</h1>
    ...
    <script src="{{ asset('js/superadmin/motoristas.js') }}"></script>
</body>
</html>