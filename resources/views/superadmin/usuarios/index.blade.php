                        ...
                        <tbody>
                            ...
                            <tr data-nome="{{ strtolower($usuario->NomeUser) }}" 
                                ...
                                <td class="text-center">
                                    <div class="row-menu">
                                        <button class="btn-menu" onclick="toggleMenuUsuario({{ $usuario->ID_USER }})">
                                            <svg viewBox="0 0 24 24" fill="currentColor">
                                                <path d="M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/>
                                            </svg>
                                        </button>

                                        <div class="dropdown-menu" id="menu-usuario-{{ $usuario->ID_USER }}">
                                            <a href="#" onclick="event.preventDefault(); editarUsuario({{ $usuario->ID_USER }})">
                                                Editar
                                            </a>

                                            <a href="#" onclick="event.preventDefault(); excluirUsuario({{ $usuario->ID_USER }})" class="delete">
                                                Excluir
                                            </a>
                                        </div>
                                    </div>
